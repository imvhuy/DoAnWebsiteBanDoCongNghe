        ...
        <div class="wrap">
            ...
            <span class="header-user wg-user">
                ...
                <span class="flex flex-column">
                    ...
                    <span class="body-text text-main-dark">
                        <c:choose>
                    ...
                    <span class="text-tiny">Admin</span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3">
                            ...
                            <li>
                                <a href="/taskboard" class="user-item">
                                    <div class="icon">
                            ...
                            <li>
                                <a href="/support" class="user-item">
                                    <div class="icon">
                            ...
                            <li>
                                <!-- Sử dụng c:url để tạo URL logout của Spring Security -->
