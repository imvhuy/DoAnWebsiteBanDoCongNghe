				...
				<div class="row">
						...
						<div class="footer-infor">
							<div class="footer-logo">
								<a href="index.html"> <img
									src="/web/images/logo/logo-white.svg" alt="">
								</a>
							</div>
							<ul>
								<li>
					...
					<div class="col-xl-3 col-md-6 col-12 footer-col-block">
						...
						<ul class="footer-menu-list tf-collapse-content">
							...
							<li><a href="terms-conditions.html" class="footer-menu_item">Terms
									&amp; Conditions</a></li>
					...
					<div class="col-xl-2 col-md-6 col-12">
						<div class="footer-newsletter footer-col-block">
							...
							<div class="tf-collapse-content">
								<div class="footer-menu_item">Sign up to get first dibs on
									new arrivals, sales, exclusive content, events and more!</div>
					...
					<div class="col-12">
						<div
							...
							<div class="tf-payment">
								<img src="/web/images/payments/visa.png" alt=""> <img
									src="/web/images/payments/img-1.png" alt=""> <img
									src="/web/images/payments/img-2.png" alt=""> <img
									src="/web/images/payments/img-3.png" alt=""> <img
									src="/web/images/payments/img-4.png" alt="">
							</div>
						</div>
					</div>
				</div>
