...
/* Đổi màu biểu tượng */
.item.edit i {
	color: #477bda; /* Màu của biểu tượng */
				...
				<div class="section-menu-left-wrap">
					<div class="center">
						<div class="center-item">
							<ul class="">
								<li class="menu-item"><a href="index.html" class="">
										<div class="icon">
								...
								<li class="menu-item has-children"><a
									...
									<ul class="sub-menu">
										<li class="sub-menu-item"><a href="product-list.html"
											class="">
												<div class="text">All Products</div>
										</a></li>
										<li class="sub-menu-item"><a href="add-product.html"
											class="">
								...
								<li class="menu-item has-children"><a
									...
									<ul class="sub-menu">
										<li class="sub-menu-item"><a href="attributes.html"
											class="">
												<div class="text">Attributes</div>
										</a></li>
										<li class="sub-menu-item"><a href="add-attributes.html"
											class="">
								...
								<li class="menu-item has-children"><a
									...
									<ul class="sub-menu">
										<li class="sub-menu-item"><a href="oder-list.html"
											class="">
												<div class="text">Order list</div>
										</a></li>
										<li class="sub-menu-item"><a href="oder-detail.html"
											class="">
												<div class="text">Order detail</div>
										</a></li>
										<li class="sub-menu-item"><a href="oder-tracking.html"
											class="">
								...
								<li class="menu-item has-children"><a
									...
									<ul class="sub-menu">
										<li class="sub-menu-item"><a href="all-user.html"
											class="">
								...
								<li class="menu-item has-children"><a
									...
									<ul class="sub-menu">
										<li class="sub-menu-item"><a
											href="https://themesflat.co/html/ecomus/index.html" class="">
												<div class="text">View Store</div>
										</a></li>
										<li class="sub-menu-item"><a href="store-setting.html"
											class="">
								...
								<li class="menu-item"><a href="setting.html" class="">
										<div class="icon">
								...
								<li class="menu-item"><a href="faq.html" class="">
										<div class="icon">
											<svg width="24" height="22" viewBox="0 0 20 20" fill="none"
												xmlns="http://www.w3.org/2000/svg">
                                                    <path
								...
								<li class="menu-item"><a href="login.html" class="">
										<div class="icon">
											<svg width="24" height="22" viewBox="0 0 20 20" fill="none"
												xmlns="http://www.w3.org/2000/svg">
                                                    <path
										...
										<li>
											<div class="message-item item-1">
												...
												<div>
													...
													<div class="text-tiny">Morbi sapien massa, ultricies
														at rhoncus at, ullamcorper nec diam</div>
												</div>
											</div>
										</li>
										<li>
											<div class="message-item item-2">
												...
												<div>
													...
													<div class="text-tiny">Mauris libero ex, iaculis
														vitae rhoncus et</div>
												</div>
											</div>
										</li>
										<li>
							...
							<div class="popup-wrap user type-header">
								<div class="dropdown">
									<button class="btn btn-secondary dropdown-toggle" type="button"
										...
										</span> <span class="flex flex-column"> <span
												class="body-text text-main-dark">Kristin Watson</span> <span
												class="text-tiny">Sale Administrator</span>
										</span>
										</span>
									</button>
									<ul class="dropdown-menu dropdown-menu-end has-content"
										aria-labelledby="dropdownMenuButton3">
										<li><a href="#" class="user-item">
												<div class="icon">
													<i class="icon-user"></i>
												</div>
										...
										<li><a href="setting.html" class="user-item">
												<div class="icon">
										...
										<li><a href="login.html" class="user-item">
												<div class="icon">
											...
											<div class="modal-content">
												...
												<div class="modal-footer" style="background-color: #ffe4e1;">
													<button type="button" class="btn btn-secondary"
														...
														style="background-color: #ffab53; color: white;">Cancel</button>
