						...
						<div class="tf-product-media-wrap sticky-top">
							<div class="thumbs-slider">
								<div dir="ltr"
									...
									<div class="swiper-wrapper stagger-wrap">
										...
										<iframe width="100%" height="auto"
											style="max-width: 544px; max-height: 846px; object-fit: contain; border: none;" src="${product.video}"
											frameborder="0"
								...
								<div dir="ltr" class="swiper tf-product-media-main"
									...
									<iframe width="100%" height="auto"
											style="max-width: 700px; max-height: 500px; object-fit: contain; border: none;"
