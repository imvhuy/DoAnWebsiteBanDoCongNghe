                    ...
                    <div class="card-product">
                        <div class="card-product-wrapper">
                            <a href="product-detail.html" class="product-img">
                                <img class="lazyload img-product" data-src="${product.image}" src="${product.image}" alt="image-product" style = " object-fit: contain;">
                                <img class="lazyload img-hover" data-src="${product.image}" src="${product.image}" alt="image-product" style = " object-fit: contain;">
                            </a>
                            <div class="list-product-btn type-wishlist">
                                <a href="javascript:void(0);" class="box-icon bg_white wishlist"  onclick="removeFromFavoriteProducts (${product.productId})">
