...
<body class="preload-wrapper">
	...
	document.addEventListener("DOMContentLoaded", function () {
	    // Gán sự kiện click cho tất cả các nút "Remove"
	    document.querySelectorAll(".remove-cart").forEach(button => {
	        button.addEventListener("click", function () {
	            const cartItemId = this.getAttribute("data-id"); // Lấy id từ data-id
	            console.log("cartItemId11111111111 : ",cartItemId);
	                // Gửi yêu cầu AJAX tới controller
	            	 // Gửi yêu cầu AJAX để cập nhật quantity trong database
	                $.ajax({
	                    url: "/user/cart/removeCartItem", // URL của API xử lý cập nhật
	                    method: "POST",
	                    contentType: "application/json",
	                    data: JSON.stringify({
	                    	cartItemId: cartItemId
	                    ...
	                    error: function (xhr, status, error) {
	                        console.error("Update failed: ", error);
	                        alert("Failed to remove this item. Please try again.");
	                    }
	                });
	        });
	    });
