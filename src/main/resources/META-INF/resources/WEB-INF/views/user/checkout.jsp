												...
												<div class="mega-menu-item">
													...
													<ul class="menu-list">
														...
														<li><a href="product-bottom-thumbnails.html"
															class="menu-link-text link">Product bottom thumbnails</a></li>
					...
					<div class="tf-cart-footer-inner">
						...
						<form class="tf-page-cart-checkout widget-wrap-checkout">
							...
							<div class="coupon-box">
								<input type="text" placeholder="Discount code"> <a
									href="#"
							...
							<div class="wd-check-payment">
								<div class="fieldset-radio mb_20">
									<input type="radio" name="payment" id="bank" class="tf-check"
										checked> <label for="bank">Direct bank
										transfer</label>

								</div>
								<div class="fieldset-radio mb_20">
									<input type="radio" name="payment" id="delivery"
										class="tf-check"> <label for="delivery">Cash
										on delivery</label>
								</div>
...
<div class="offcanvas offcanvas-start canvas-mb toolbar-shop-mobile"
	...
	<div class="mb-canvas-content">
		...
		<div class="mb-bottom">
			<a href="shop-default.html" class="tf-btn fw-5 btn-line">View all
				collection<i class="icon icon-arrow1-top-left"></i>
			</a>
		</div>
	</div>
</div>
